...
<body class="bg-light">
                    ...
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-flex">
                                <div class="flex-grow-1 bg-login-image" style="background-image: url(&quot;assets/img/undip.png&quot;);"></div>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h4 class="text-dark mb-4">Login Developer</h4>
                                        <?php 
	if(isset($_GET['pesan'])){
		if($_GET['pesan']=="gagal"){
	...
	?>
                                    <div>
                                    <form class="user"  action="proseslogin_developer.php" method="post">
                                        ...
                                        </div><button class="btn btn btn-block text-white btn-user" type="submit"><a href="login_admin.php">Masuk sebagai Admin</button>
                                    </form>
                                </div>
                            </div>
                        </div>
